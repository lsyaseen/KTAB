...
function getfile() {
    ...
    fr.onload = function () {
        ...
        + " from ( select L0.Act_i, L0.Dim_k, L0.Turn_t as Movd_Turn, L0.Mover_BargnId,"
        ...
        + " where L0.Pos_Coord <> L1.Pos_Coord) as M inner join Bargn as B on M.Mover_BargnId = B.BargnId"
        ...
        + "  ActorDescription as MN on M.Act_i = MN.Act_i ORDER BY M.Dim_k");
