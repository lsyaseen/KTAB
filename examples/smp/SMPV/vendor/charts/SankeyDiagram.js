...
var data=[
  {"actor":"XY","dim1pos":50,"dim2pos":90,},
  {"actor":"LK","dim1pos":90,"dim2pos":20, },
  {"actor":"HLJ","dim1pos":30,"dim2pos":50,},
];
...
var data = []
  ...
  var actors = dimensions[0];
  for (var a = 0; a < actors.length; a++) {

    var positions1 = dimensions[0][a]['positions'];
    var positions2 = dimensions[1][a]['positions'];
    var actorName = actors[a]['name'];
      data.push({"dim1pos":positions1[0],"dim2pos":positions2[0],"actor":actorName})
  }
...
var canvas = d3.select("#SankeyDiagram").append("svg")
...
var tooltip = d3.select("#SankeyDiagram").append("div")
    .attr("class", "tooltip")
    .style("opacity", 0);
